        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Architecting, deploying, and optimizing robust cloud infrastructures.
                Focused on Infrastructure as Code to ensure scalability, security,
                and cost-efficiency.
              </p>
              ...
              <div className="what-content-flex">
                ...
                <div className="what-tags">VPC & IAM</div>
              </div>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Streamlining software delivery pipelines through automation.
                Containerizing applications and orchestrating deployments for
              ...
              <div className="what-content-flex">
                ...
                <div className="what-tags">Trivy Scan</div>
              </div>
              <div className="what-arrow"></div>
            </div>
          </div>
